...
#----- If you are modifying this script, please use above variable as starting point. Use "puts" command to report above variables ---------------------------------------------#
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
...
#return 
#While debugging you can add return to not execute the script further
...
#set Instance_count "$Instance_count sk"
#set worst_negative_hold_slack "$worst_negative_hold_slack 123"
