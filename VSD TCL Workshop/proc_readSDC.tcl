...
puts "part2 is [split [file tail 4arg1] .]"
puts "part3 is [lindex [split [file tail 4arg1] .] 0 ]"
...
foreach elem $find_keyword {
	...
	if {![string match $new_port_name $port_name]} {
		...
		puts "dl_part2 is [join [list "*" " " $port_name " " "*"] ""]s"
...
puts "sdc_dirname is $sdc_dirname" 
puts "sdc_filenameis $sdc_filename"
